...
type UpdateSecretsError = GenericApiError | ProjectAlreadyExistsError | ProjectLimitReachedError
...
): Promise<ApiResponse<null, UpdateSecretsError>> {
  return await envClient.sendApiRequest<null, UpdateSecretsError>({
    method: 'PATCH',
